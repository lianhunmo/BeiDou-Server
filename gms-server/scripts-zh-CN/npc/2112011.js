...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            cm.sendSimple("被打败了……啊，犹太的夙愿终究要在此终结了，啊……你们如今该满意了吧？我将在暗无天日的地牢里腐朽余生。我所做的一切，都是为了玛伽提亚啊！（啜泣）\r\n#Ll##b好啦好啦伙计，振作点！这里造成的损害大多还能挽回。玛伽提亚订立严苛律法，正是为了防止此等伟力落入歧途祸及子民。对你而言绝非终点——接受各协会的改造计划，未来总会好起来的！#k#l");
        } else if (status == 1) {
