...
var levels = ["#m970030001#", "#m970030002#", "#m970030003#", "#m970030004#", "#m970030005#", "最终挑战"];
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            var sendStr = "#b<组队任务：首领突袭>#k 会根据队伍在首领狩猎中的进度给予相应奖励。请注意，每位玩家#b只有在通过休息区域内的传送门离开时，才能领取奖励#k。挑战更强大的首领需要队伍持续战斗，直到抵达下一个休息区域，或直到击败最终首领。\r\n\r\n" +
                "以下是在所选休息区域离开时可获得的可能奖励：\r\n\r\n" +
                "#b";
            for (var i = 0; i < 6; i++) {
            ...
            var sendStr = "以下物品将在 #b" + levels[selection] + "#k 阶段发放：\r\n\r\n";
