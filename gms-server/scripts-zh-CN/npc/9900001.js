 ...
 * @description 拍卖行中心脚本
 */
var OldTitle ="\t\t\t\t\t#e欢迎来到#rBeiDou#k帮助中心#n\t\t\t\t\r\n";
var status = -1;
var i = 0;
function start() {
    action(1, 0, 0)
...
function action(mode, type, selection) {
    ...
    if (status === 0) {
        ...
        text += " \r\n\r\n";
        text += "#L0##b新人福利#l\t #L2#在线奖励#l\t #L6#戒指打造#l\t #L7#点装强化#l\r\n";
        text += "#L3#传送自由#l\t #L4#爆率一览#l\t #L61#超级传送#l\t #L5#一键转职#l\r\n";
        text += "#L65#删除道具#l\t #L63#整容集合#l\r\n";
