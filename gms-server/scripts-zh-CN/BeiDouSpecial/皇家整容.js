...
var fface = Array(21000,21001,21002,21003,21004,21005,21006,21007,21008,21009,21010,21011,21012,21013,21014,21015,21016,21017,21018,21019,21020,21021,21022,21023,21024,21025,21026,21027,21028,21029,21030,21031,21033,21034,21035,21036,21038,21044,21045,21046,21047,21048,21052,21053,21054,21055,21056,21057,21058,21059,21060,21061,21062,21063,21064,21065,21068,21069,21070,21071,21072,21073,21074,21075,21076,21077,21078,21079);
...
function action(mode, type, selection) {
    if (mode == -1)
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("#L2##i5152001# #t5152001#  自选脸型#l\r\n");
        } else if (status == 1) {
            if (selection == 1) {
                if(cm.getMeso() >= price) {
                    cm.gainMeso(-price);
				...
				cm.sendStyle("使用高级会员卡，你可以选择你的脸型。请选择最能给你带来快乐的款式。", facenew);
            }
        }
        else if (status == 2){
            cm.dispose();
            if (cm.haveItem(5152001) == true){
                ...
                cm.sendOk("你身上没有#b#z5152001##k#i5152001#..");
        }
    }
}
